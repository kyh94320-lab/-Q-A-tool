...
1.  **Open the Website**: Double-click on `index.html` in the folder `c:\Users\kyh94\OneDrive\Desktop\마음치유, 봄처럼`.
2.  **Search**: Type your question or keyword (e.g., "지원 규모", "신청 방법") in the search bar.
3.  **View Results**: Browse the cards that appear below. They show the document name and the relevant text.
